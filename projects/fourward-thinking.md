...
<div style="text-align: center;">
  ...
  <br>
  <img src="../img/fourward-thinking/session-details-coded.png" alt="Create study session page" width="750" style="padding-top: 16px; padding-bottom: 24px;" />
  <br>
  <p style="font-size: 18px;">backend implemented</p>
</div>
...
<div style="text-align: center;">
  ...
  <br>
  <img src="../img/fourward-thinking/session-details-coded.png" alt="Study sessions detail page" width="750" style="padding-top: 16px; padding-bottom: 24px;" />
  <br>
  <p style="font-size: 18px;">no backend implementation</p>
</div>
