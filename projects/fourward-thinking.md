...
<div style="text-align: center;">
  ...
  <br>
  <img src="../img/fourwardthinking/create-session-coded.png" alt="Create study session page" width="750" style="padding-top: 16px; padding-bottom: 24px;" />
  <br>
...
<div style="text-align: center;">
  ...
  <br>
  <strong style="font-size: 18px; padding-bottom: 24px;">no backend implementation</strong>
</div>
